...
exec su - tester sh -c "git clone $TESTSUITE; cd /home/tester/storm-testsuite; git checkout $BRANCH_TESTSUITE; pybot --pythonpath lib --variable backEndHost:$STORM_BE_HOST --exclude to-be-fixed -d reports tests"
